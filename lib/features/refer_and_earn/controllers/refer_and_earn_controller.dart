...
class ReferAndEarnController extends GetxController implements GetxService {
  ...
  static const String referralBaseLink = 'https://www.lokally.com.br';
  ...
  String get referralLink {
    if (referralCode.isEmpty) {
      return referralBaseLink;
    }

    return '$referralBaseLink/$referralCode';
  }

  String get referralShareText {
    if (referralCode.isEmpty) {
      return 'Baixe o app Lokally e venha se mover com a gente.\n\n$referralBaseLink';
    }

    return 'Estou te convidando para usar o app Lokally. Acesse pelo meu link de indicação e cadastre-se:\n\n$referralLink';
  }
