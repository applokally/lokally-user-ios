...
class NotificationRepository implements NotificationRepositoryInterface {
  ...
  Future<Response> getList({
    ...
    return await apiClient.getData(
      '${AppConstants.notificationList}$offset&read_status=$readStatus',
    );
  }
  ...
  Future<Response> sendReadStatus(int notificationId) async {
    return await apiClient.putData(
        AppConstants.readNotification, {"notification_id": notificationId});
  }

  @override
  Future<Response> deleteNotification(int notificationId) async {
    return await apiClient.deleteData(
      '${AppConstants.deleteNotification}?notification_id=$notificationId',
    );
  }
