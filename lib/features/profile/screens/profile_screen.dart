...
class ProfileScreen extends StatelessWidget {
            ...
            body: SingleChildScrollView(
              ...
              child: Column(children: [
                ...
                ProfileMenuItem(
                  ...
                  icon: Images.profileMyTrip,
                  onTap: () =>
                      Get.to(() => const StoreCustomerOrderListScreen()),
                ),
                ProfileMenuItem(
                  title: 'safety',
  ...
  Future<bool> _isApprovedMarketplaceSeller() async {
    try {
      final response = await Get.find<ApiClient>().getData(
        AppConstants.storeSellerStatus,
      );
      ...
      return approvalStatus == 'approved' && canCreateProducts;
    } catch (_) {
      return false;
    }
  }
