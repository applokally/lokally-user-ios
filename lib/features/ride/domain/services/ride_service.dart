...
class RideService implements RideServiceInterface {
  ...
  Future getFinalFare(
    ...
    return await rideRepositoryInterface.getFinalFare(
      id,
  ...
  Future submitRideRequest({
    ...
    return await rideRepositoryInterface.submitRideRequest(
        ...
        extraOne: extraOne,
        extraTwo: extraTwo,
        extraLatOne: extraLatOne,
        extraLatTwo: extraLatTwo,
        extraLngOne: extraLngOne,
        extraLngTwo: extraLngTwo,
        scheduledAt: scheduledAt,
  ...
  Future updateScheduleTripTimeDate(String? tripId, String? scheduledAt) async {
    return await rideRepositoryInterface.updateScheduleTripTimeDate(
        tripId, scheduledAt);
  }
}
